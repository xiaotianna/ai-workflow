...
function WorkflowPanelTabsList({ className, ...props }: ComponentProps<typeof TabsList>) {
  return (
    <TabsList
...
function WorkflowPanelTabsTrigger({ className, ...props }: ComponentProps<typeof TabsTrigger>) {
  return (
    <TabsTrigger
      className={cn(
...
export { WorkflowPanelTabsList, WorkflowPanelTabsTrigger }
