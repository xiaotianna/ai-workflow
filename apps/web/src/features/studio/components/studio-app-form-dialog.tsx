...
interface StudioAppFormDialogProps {
  initialValues: CreateStudioAppFormInput
  open: boolean
  submitLabel: string
  title: string
  onOpenChange: (open: boolean) => void
  onSubmit: (input: CreateStudioAppInput) => unknown | Promise<unknown>
}

export function StudioAppFormDialog({
  initialValues,
  open,
  submitLabel,
  title,
